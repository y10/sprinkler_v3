...
Use the following information to understand how to create your document:
    - create your file under `.claude/thoughts/shared/handoffs/ENG-XXXX/YYYY-MM-DD_HH-MM-SS_ENG-ZZZZ_description.md`, where:
    ...
    - Generate metadata inline using git commands:
        - Current date/time: Use ISO format with timezone
...
### 3. Save and Present
Save the handoff document (no sync needed, files are local).
...
```bash
/resume_handoff .claude/thoughts/shared/handoffs/ENG-2166/2025-01-08_13-44-55_ENG-2166_create-context-compaction.md
```
</example_response>
